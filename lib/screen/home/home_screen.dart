...
class _HomeScreenState extends State<HomeScreen> with ManualNavigatorMixin {
  ...
  Widget friendOfferGridItem(String image, String name, String business) {
        ...
        children: [
          ...
          CustomTextView(
            textPaste: sampleBiznesModels.elementAt(
              ((int.tryParse(business) ?? 0) + 1) < sampleBiznesModels.length && ((int.tryParse(business) ?? 0) + 1) > -1 ? ((int.tryParse(business) ?? 0) + 1) : 0,
            ),
            textSize: 13,
